...
# Load the data
data <- read_parquet(here("../datasets/law-firms/smb.parquet"))
revexp <- read_parquet(here("../datasets/law-firms/revexp.parquet"))
empl <- read_parquet(here("../datasets/law-firms/empl.parquet"))
