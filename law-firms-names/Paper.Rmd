...
csl: "journal-article/apa_numeric.csl"
...
```{r fig-2-global-moran-i, fig.cap="Fig. 2. Global Moran's *I* statistics and p-values for law firm naming patterns", fig.height=4}
moran_test_global_res_plot
```

```{r fig-3-localmoran-maps, fig.cap="Fig. 3. Maps of hotspots in the spatial distribution of three law firms naming patterns", fig.height=5}
localmoran_maps
```
