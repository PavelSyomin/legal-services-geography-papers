---
title: "Discovering and Analysing Spatial Heterogenity in Russian Law Firms Naming Using Text Embeddings"
author: "Pavel Syomin"
output:
  word_document:
...
### 2.2.4. Settlement embeddings

The embeddings of firm names are grouped by settlement and averaged. In this paper, these average vectors are referred to as settlement embeddings or settlement vectors. Each vector represents the combined meaning associated with the names of law firm names within a specific settlement. The mathematical similarity of settlement vectors is analogous to the similarity of law firm names in settlements. Settlement embeddings were introduced to reduce computational complexity of working with individual vectors. Multiple law firms may be located in the same settlement, and with the absence of within-city variation, it is possible to treat their names vectors as a single object.
