...
**Abstract:** The article examines the relationship between the number of employees at law firms and the provision of legal services in Russian cities. It aims to identify whether the increase in the number of lawyers leads an enhanced level of legal services provision. In addition, it attempts to discern geographical patterns in the provision of legal services in Russia. To achieve these objectives, open data from the Federal Tax Service of Russia is utilized as the primary source of information. A linear regression is employed to estimate the hypothesized relationship, and data plotting and mapping are used to visualize it. The study demonstrates an overall positive square root relationship between the number of lawyers and the provision of legal services in cities, as well as a linear relationship between these variables in distinct city population size groups. It supports a widely held proposition about the pivotal role of the largest cities in the provision of services and also offers partial confirmation of the commonly accepted view about the positive impact of services concentration on their delivery. However, the study argues that there are multiple approaches to achieving high level of legal services provision, with an increase in the number of lawyers being only one of potential options. The findings of this research may serve to inform data-driven policymaking decisions of governmental bodies.
...
Figure 2 depicts the relationship between the number of lawyers and the provision of legal services. The overall connection between the number of law firms and the provision of legal services appears to be nonlinear, with a square root function providing an accurate fit. However, the same relationship within each population size group is well-fitted by a linear model in most of the cases. As illustrated in Table 1, the coefficients of these models differ, and the slope declines as the city population increases. The regression line for small cities is close to Type 4, and the small coefficient of determination (R² = 0.11) indicates that the provision is almost independent of the number of lawyers, likely due to the low variation of the latter. The modeled relationship in millionaire cities resembles Type 1, which is another option for independence caused by relatively uniform and equal provision regardless of the number of lawyers. The coefficient of determination here is also relatively low (R² = 0.51), although greater than in the group of small cities. Cities of medium to extra-large size are characterized by a positive correlation between the number of lawyers and the provision of legal services, which can be classified as Type 2. The coefficient of determination is high (R² is approximately 0.9), indicating that nearly all the variance in the provision of legal services can be explained by the number of lawyers.
