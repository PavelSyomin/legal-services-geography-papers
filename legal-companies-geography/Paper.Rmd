...
```{r fig-3-employees-map, fig.cap="Figure 3. The national and regional median annual shares of lawyers in regions of Russia over the period from 2018 to 2021"}
employees_map
```
...
```{r fig-4-timeline-map, fig.cap="Figure 4. The change in the number of law firms by region over the period from 2016 to 2021"}
timeline_map
```
