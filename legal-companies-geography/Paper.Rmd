...
The second problem is the *structure of legal business in regions* with respect to the kind of firms (either individual entrepreneurs or organisations) and the size of organisations (either micro, small, and medium). To answer this question, legal firms are counted by region, kind and type, and the result is visualized on a geofacetted plot.
