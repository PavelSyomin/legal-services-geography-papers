# Paper about legal services geography in Russia

The paper “Legal Business Geography in Russia: Regional Analysis and Mapping Using Tax Service Open Data” was prepared for the InterCarto. InterGIS 30th conference (Kazakhstan, Ust-Kamenogorsk, October 1–3, 2024 & Russia, Grozny, October 7–9, 2024) and then published in the conference proceeginds. The publication file is `Paper_published.pdf`. The bibtex entry is below.

```
@inproceedings{Syomin_legal_services_geography_2024,
    address={Moscow},
